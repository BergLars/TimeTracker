...
@NgModule({
    ...
    providers: [ProjectService, TaskService, TimeTrackingEntryService, UserService, LoginService, EntryDialogService, DeleteEntryService, UpdateDialogService, PasswordDialogService, ClientService, CreateDialogService, ExportDialogService],
